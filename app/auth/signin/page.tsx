...
function SignInContent() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-ui-soft px-4">
      <div className="bg-card p-8 rounded-2xl shadow-lg border border-border-light max-w-md w-full text-center">
        <h1 className="text-3xl font-bold text-text-primary mb-2">Welcome Back</h1>
        <p className="text-text-secondary mb-8">Sign in to access your saved properties</p>

        {error && (
          <div className="bg-accent-error/10 text-accent-error px-4 py-3 rounded-lg mb-6 text-sm">
            {error === "OAuthCallback" 
        ...
        <div className="space-y-4">
          <Button 
            className="w-full h-12 text-lg font-medium border-border-light hover:bg-gray-50 text-text-primary" 
            variant="outline"
